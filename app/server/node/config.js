...
const config = {
  DATABASE_PATH: process.env.DATABASE_PATH || path.join(process.cwd(), 'data', 'pregnancy-journal.db'),
  ...
  PORT: parseInt(process.env.TRIM_SERVICE_PORT || process.env.PORT || '21039', 10),
