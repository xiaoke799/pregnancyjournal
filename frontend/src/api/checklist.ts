...
export const checklistApi = {
  ...
  update: (id: string, name: string) => client.put(`/checklists/${id}`, { name }),
  delete: (id: string) => client.delete(`/checklists/${id}`),
  ...
  ensureDefaults: (pregnancyId: string) => client.post('/checklists/ensure-defaults', { pregnancy_id: pregnancyId }),
}
